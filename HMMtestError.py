...
from helperFunctions import getWordNumDict
...
class HiddenMarkovModel:
    ...
    def __init__(self, A, O):
        '''
        Initializes an HMM. Assumes the following:/Users/annaresnick/Documents/155/miniproject3/Set6_Solutions/src/HMM.py
